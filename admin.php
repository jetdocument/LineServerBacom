            ...
            <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <?php  
                        ...
                        if ($_SESSION['data']['group'] == "Admin") {
                            ...
                            $get_admin_list = "SELECT * FROM `user`";
                            ...
                            foreach ($admin_result as $key => $value) {                                
                                    ...
                                    echo "  <tr>
                                            ...
                                            <td>".$value['group']."</td> 
                                            <td><button type='button' class='btn btn-success deleteUser' onclick=''>Delete</button></td>
                                        </tr>";
                            } 

                        } else if ($_SESSION['data']['group'] == "User") {

                            $get_server_list = "SELECT * FROM `user` WHERE `username` = '".$_SESSION['data']['username']."'";
